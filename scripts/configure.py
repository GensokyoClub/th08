...
def configure(build_type):
    with (SCRIPTS_DIR.parent / "build.ninja").open("w") as f:
        ...
        writer.variable("cl_flags", "$cl_common_flags /Gr")
        ...
        cxx_flags_per_source = {
            ...
            "TextHelper": small_no_intrinsic_codegen,
        ...
        writer.rule(
            "cc_th_pch",
            '$cl /nologo /showIncludes $cl_flags /Od /Oi /Yc"th_pch.h"'
